...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, '🤖 Ynz вσт', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), '🎮 Ynz вσт', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
...
let fot = `Made by @${'6288287810316'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
